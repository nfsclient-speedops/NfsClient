 ...
 */
public abstract class GenericAsyncTask<Params, Progress, Result> {
...
//    }
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link GenericAsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link GenericAsyncTask.Status#RUNNING} or {@link GenericAsyncTask.Status#FINISHED}.
     */
    public final GenericAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     *         {@link GenericAsyncTask.Status#RUNNING} or {@link GenericAsyncTask.Status#FINISHED}.
     */
    public final GenericAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final GenericAsyncTask<?, ?, ?> mTask;
        final Data[] mData;

        AsyncTaskResult(GenericAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
