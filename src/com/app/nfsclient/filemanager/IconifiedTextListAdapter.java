...
*/
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
          ...
          btv.setTextColor(Background.textColorGet(mContext));
          btv.setInfo(mItems.get(position).getInfo());
          btv.setInfoColor(Background.textColorGet(mContext));
          
          Drawable drawable = ImagesUtils.drawableScale(mContext, mItems.get(position).getIcon(),
		      ImagesUtils.itemDefaultBitmapImageGet(mContext), 1f);
          btv.setIcon(drawable);
